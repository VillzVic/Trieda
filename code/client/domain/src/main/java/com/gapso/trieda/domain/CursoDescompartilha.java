...
public class CursoDescompartilha implements Serializable {
	...
	public static int count() {
        return ((Number) entityManager().createQuery("SELECT COUNT(o) FROM CursoDescompartilha o").getSingleResult()).intValue();
    }

	@SuppressWarnings("unchecked")
    public static List<CursoDescompartilha> findAll() {
        return entityManager().createQuery("SELECT o FROM CursoDescompartilha o").getResultList();
    }

	public static CursoDescompartilha find(Long id) {
        if (id == null) return null;
        return entityManager().find(CursoDescompartilha.class, id);
    }

	@SuppressWarnings("unchecked")
    public static List<CursoDescompartilha> find(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM CursoDescompartilha o").setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
