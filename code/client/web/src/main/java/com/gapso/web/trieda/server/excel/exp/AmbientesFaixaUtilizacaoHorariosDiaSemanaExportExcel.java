...
public class AmbientesFaixaUtilizacaoHorariosDiaSemanaExportExcel
	extends AbstractExportExcel
{
	...
	public AmbientesFaixaUtilizacaoHorariosDiaSemanaExportExcel( Cenario cenario, TriedaI18nConstants i18nConstants,
	...
	public AmbientesFaixaUtilizacaoHorariosDiaSemanaExportExcel( boolean removeUnusedSheets, Cenario cenario,
	...
	public AmbientesFaixaUtilizacaoHorariosDiaSemanaExportExcel( boolean removeUnusedSheets,
			Cenario cenario, TriedaI18nConstants i18nConstants,
			TriedaI18nMessages i18nMessages, ExportExcelFilter filter,
			InstituicaoEnsino instituicaoEnsino, String fileExtension )
	{
		super( true, ExcelInformationType.AMBIENTES_FAIXA_UTILIZACAO_SEMANA.getSheetName(), cenario, i18nConstants, i18nMessages, instituicaoEnsino, fileExtension );
	...
	{
		return getI18nConstants().ambientesFaixaUtilizacaoSemana();
	}
	...
	protected boolean fillInExcel( Workbook workbook )
	{
		...
		for ( CampusDTO campusDTO : campusDTOList )
		{
			relatorioDocenteDTO.addAll(
					atendimentosServiceImpl.getAmbientesFaixaOcupacaoHorariosPorDiaSemana(ConvertBeans.toCenarioDTO(getCenario()), campusDTO) );
		}
