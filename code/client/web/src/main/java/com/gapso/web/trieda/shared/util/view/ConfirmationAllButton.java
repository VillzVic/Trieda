...
public class ConfirmationAllButton extends Button
{
	...
	public ConfirmationAllButton(ITriedaI18nGateway i18nGateway, String showEntidade) {
	...
	/*public ConfirmationAllButton(ITriedaI18nGateway i18nGateway, String confirmacao) {
		addConfirmationListener();
		this.i18nGateway = i18nGateway;
	...
	public void addConfirmationListener() {
		super.addSelectionListener(new SelectionListener<ButtonEvent>(){
			...
			public void componentSelected(final ButtonEvent ce) {
				MessageBox.confirm(confirmacao, i18nGateway.getI18nMessages().confirmacaoAllButton(entidade), new Listener<MessageBoxEvent>() {
					@Override
