...
public class AmbientesFaixaUtilizacaoHorariosDiaSemanaPresenter
	implements Presenter
{
	...
	public AmbientesFaixaUtilizacaoHorariosDiaSemanaPresenter(
	...
	private void setListeners()
	{
				...
				new SelectionChangedListener< CampusDTO >()
		{
				...
				SelectionChangedEvent< CampusDTO > se )
			{
				...
				Services.atendimentos().getAmbientesFaixaOcupacaoHorariosPorDiaSemana( cenarioDTO, se.getSelectedItem(),
				...
				new SelectionListener< MenuEvent >()
		{
			...
			public void componentSelected( MenuEvent ce )
			{
				...
				ExcelParametros parametros = new ExcelParametros(
					ExcelInformationType.AMBIENTES_FAIXA_UTILIZACAO_SEMANA, instituicaoEnsinoDTO, cenarioDTO, fileExtension );
