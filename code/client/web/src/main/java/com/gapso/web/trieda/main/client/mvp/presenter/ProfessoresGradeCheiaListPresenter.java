...
public class ProfessoresGradeCheiaListPresenter
	extends ProfessoresListPresenter 
{

	public ProfessoresGradeCheiaListPresenter(
	...
	protected void configureProxy() {
			...
			new RpcProxy< PagingLoadResult< ProfessorDTO > >()
		{
				...
				AsyncCallback< PagingLoadResult< ProfessorDTO > > callback)
			{
				...
				service.getBuscaListGradeCheia(cenario, cpf, campusDTO, display.getProfessorFiltro(), (PagingLoadConfig) loadConfig, callback);
			}
		};
				...
				new SelectionListener< MenuEvent >()
		{
			...
			public void componentSelected( MenuEvent ce )
			{
				...
				ExcelParametros parametros = new ExcelParametros(
					ExcelInformationType.PROFESSORES_GRADE_CHEIA, instituicaoEnsinoDTO, cenario, fileExtension );
