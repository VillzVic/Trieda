...
public class ProfessoresExportExcel extends AbstractExportExcel {
	...
	public ProfessoresExportExcel(Cenario cenario, TriedaI18nConstants i18nConstants, TriedaI18nMessages i18nMessages) {
	...
	public ProfessoresExportExcel(boolean removeUnusedSheets, Cenario cenario, TriedaI18nConstants i18nConstants, TriedaI18nMessages i18nMessages) {
		super(cenario,i18nConstants,i18nMessages);
		this.cellStyles = new HSSFCellStyle[ExcelCellStyleReference.values().length];
	...
	// CPF | Nome | Tipo | Carga Horária Máx. | Carga Horária Min. | Titulação | Área de Titulação | Carga Horária Anterior | Crédito (R$)
	private int writeData(Professor professor, int row, HSSFSheet sheet) {
		...
		// Carga Horária Min
		setCell(row,6,sheet,cellStyles[ExcelCellStyleReference.NUMBER_INT.ordinal()],professor.getCargaHorariaMax());
		// Titulação
