...
public class ProfessorVirtualComboBox extends ComboBox<ProfessorVirtualDTO> {
	...
	public ProfessorVirtualComboBox(CampusComboBox campusCB) {
		...
		setStore(new ListStore<ProfessorVirtualDTO>(new BaseListLoader<BaseListLoadResult<ProfessorVirtualDTO>>(proxy)));
