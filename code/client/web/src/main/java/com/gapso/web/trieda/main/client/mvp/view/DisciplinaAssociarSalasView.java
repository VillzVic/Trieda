...
import com.gapso.web.trieda.main.client.mvp.presenter.DisciplinaAssociarSalasPresenter;
...
public class DisciplinaAssociarSalasView extends MyComposite implements
DisciplinaAssociarSalasPresenter.Display
{
	...
	private ListView<DisciplinaDTO> naoVinculadaList;
	private ListView<DisciplinaDTO> vinculadaList;
	...
	public DisciplinaAssociarSalasView( CenarioDTO cenarioDTO, SalaDTO salaDTO ) {
	...
	private void initUI() {
		...
		panel.setHeadingHtml(cenarioDTO.getNome() + " » Associação de Ambientes à Disciplinas");
	}
	
	private void createTabItem() {
		tabItem = new GTabItem("Associação de Ambientes à Disciplinas", Resources.DEFAULTS.associacaoDisciplinaSala16());
	...
	private void createForm() {
		...
		naoVinculadaListPanel.setHeadingHtml("Disciplinas(s) NÃO vinculado(s) ao Ambiente");
		naoVinculadaList = new ListView<DisciplinaDTO>();
		...
		vinculadaListPanel.setHeadingHtml("Disciplinas(s) vinculado(s) ao Ambiente");
		vinculadaList = new ListView<DisciplinaDTO>();
		if(salaDTO.getId() == null)
	...
	@Override
		public ListView<DisciplinaDTO> getNaoVinculadaList() {
		return naoVinculadaList;
	}
	
	@Override
		public ListView<DisciplinaDTO> getVinculadaList() {
