...
public class ProfessoresBemAlocadosListPresenter
	extends ProfessoresListPresenter 
{

	public ProfessoresBemAlocadosListPresenter(
	...
	protected void configureProxy() {
			...
			new RpcProxy< PagingLoadResult< ProfessorDTO > >()
		{
				...
				AsyncCallback< PagingLoadResult< ProfessorDTO > > callback)
			{
				...
				service.getBuscaListBemAlocados(cenario, cpf, campusDTO, display.getProfessorFiltro(), (PagingLoadConfig) loadConfig, callback);
			}
		};
				...
				new SelectionListener< MenuEvent >()
		{
			...
			public void componentSelected( MenuEvent ce )
			{
				...
				ExcelParametros parametros = new ExcelParametros(
					ExcelInformationType.PROFESSORES_BEM_ALOCADOS, instituicaoEnsinoDTO, cenario, fileExtension );
