...
public class ProfessoresDisciplinasLecionadasExportExcel
	extends AbstractExportExcel
{
	...
	public ProfessoresDisciplinasLecionadasExportExcel( Cenario cenario, TriedaI18nConstants i18nConstants,
	...
	public ProfessoresDisciplinasLecionadasExportExcel( boolean removeUnusedSheets, Cenario cenario,
	...
	public ProfessoresDisciplinasLecionadasExportExcel( boolean removeUnusedSheets,
			Cenario cenario, TriedaI18nConstants i18nConstants,
			TriedaI18nMessages i18nMessages, ExportExcelFilter filter,
			InstituicaoEnsino instituicaoEnsino, String fileExtension )
	{
		super( true, ExcelInformationType.PROFESSORES_DISCIPLINAS_LECIONADAS.getSheetName(), cenario, i18nConstants, i18nMessages, instituicaoEnsino, fileExtension );
	...
	{
		return getI18nConstants().professoresDisciplinasLecionadas();
	}
	...
	protected boolean fillInExcel( Workbook workbook, Workbook templateWorkbook )
	{
		...
		for ( CampusDTO campusDTO : campusDTOList )
		{
			relatorioDocenteDTO.addAll(
					atendimentosServiceImpl.getProfessoresDisciplinasLecionadas(ConvertBeans.toCenarioDTO(getCenario()), campusDTO, null) );
		}
