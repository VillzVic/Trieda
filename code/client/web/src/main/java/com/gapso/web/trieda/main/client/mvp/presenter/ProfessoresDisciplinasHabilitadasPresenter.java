...
public class ProfessoresDisciplinasHabilitadasPresenter	
	implements Presenter
{
	...
	public ProfessoresDisciplinasHabilitadasPresenter(
	...
	private void setListeners()
	{
				...
				new SelectionChangedListener< CampusDTO >()
		{
				...
				SelectionChangedEvent< CampusDTO > se )
			{
				...
				Services.professores().getProfessoresDisciplinasHabilitadas( cenarioDTO, se.getSelectedItem(),
			...
			new SelectionListener< ButtonEvent >()
		{
			...
			public void componentSelected( ButtonEvent ce )
			{
				...
				display.getGrid().mask( display.getI18nMessages().loading() );
				Services.professores().getProfessoresDisciplinasHabilitadas( cenarioDTO, display.getCampusComboBox().getValue(),
						display.getTipoProfessorComboBox().getValue(),
						new AbstractAsyncCallbackWithDefaultOnFailure< List < RelatorioQuantidadeDTO > >( display )
				{
					@Override
