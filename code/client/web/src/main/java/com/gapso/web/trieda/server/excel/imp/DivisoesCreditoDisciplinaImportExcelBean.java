...
public class DivisoesCreditoDisciplinaImportExcelBean
	extends AbstractImportExcelBean
	implements Comparable< DivisoesCreditoDisciplinaImportExcelBean >
{
	...
	public DivisoesCreditoDisciplinaImportExcelBean( int row )
	{
		super( row );
	}
	...
	{
		return (isEmptyField( this.disciplinaCodigoStr ) && isEmptyField( this.creditosStr ) &&
	...
	@Override
	public int compareTo( DivisoesCreditoDisciplinaImportExcelBean o )
	{
