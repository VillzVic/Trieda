...
public class DemandaDTO extends AbstractDTO<String>
	...
	public int compareTo(DemandaDTO o) {
		...
		if (result == 0) {
			...
			if (result == 0) {
				...
				if (result == 0) {
					result = getCurriculoString().compareTo(
							o.getCurriculoString());
					if (result == 0) {
						result = getDisciplinaString().compareTo(
								o.getDisciplinaString());
					}
				}
			}
		}
