...
public class AtendimentosFaixaTurmaPresenter
	implements Presenter
{
		...
		extends ITriedaI18nGateway
	{
		...
		Grid< AtendimentoFaixaTurmaDTO > getGrid();
		ListStore< AtendimentoFaixaTurmaDTO > getStore();
	...
	public AtendimentosFaixaTurmaPresenter(
	...
	private void setListeners()
	{
				...
				new SelectionChangedListener< CampusDTO >()
		{
				...
				SelectionChangedEvent< CampusDTO > se )
			{
				...
				Services.atendimentos().getAtendimentosFaixaTurma( cenarioDTO, se.getSelectedItem(),
				new AbstractAsyncCallbackWithDefaultOnFailure< List < AtendimentoFaixaTurmaDTO > >( display )
				{
					@Override
					public void onSuccess(
						List< AtendimentoFaixaTurmaDTO > list )
						{
