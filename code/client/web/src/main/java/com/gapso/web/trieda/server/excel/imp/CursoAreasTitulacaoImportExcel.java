...
public class CursoAreasTitulacaoImportExcel extends AbstractImportExcel<CursoAreasTitulacaoImportExcelBean>
{
	...
	public CursoAreasTitulacaoImportExcel(Cenario cenario, TriedaI18nConstants i18nConstants, TriedaI18nMessages i18nMessages, InstituicaoEnsino instituicaoEnsino)
	{
	...
	@Override
	protected CursoAreasTitulacaoImportExcelBean createExcelBean(Row header, Row row)
	{
	...
	@Override
	protected boolean doSyntacticValidation(List<CursoAreasTitulacaoImportExcelBean> sheetContent)
	{
	...
	@Override
	protected boolean doLogicValidation(List<CursoAreasTitulacaoImportExcelBean> sheetContent)
	{
	...
	private void checkNonRegisteredAreaTitulacao(List<CursoAreasTitulacaoImportExcelBean> sheetContent)
	{
		...
		Map<String, AreaTitulacao> areasBDMap = AreaTitulacao.buildAreaTitulacaoCodigoToAreaTitulacaoMap(AreaTitulacao.findByCenario(this.instituicaoEnsino, getCenario()));
	...
	@Transactional
	@Override
	protected void updateDataBase(List<CursoAreasTitulacaoImportExcelBean> sheetContent)
	{
