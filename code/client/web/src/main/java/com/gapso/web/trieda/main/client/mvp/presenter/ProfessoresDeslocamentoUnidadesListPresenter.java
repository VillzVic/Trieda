...
public class ProfessoresDeslocamentoUnidadesListPresenter
	extends ProfessoresListPresenter 
{

	public ProfessoresDeslocamentoUnidadesListPresenter(
	...
	protected void configureProxy() {
			...
			new RpcProxy< PagingLoadResult< ProfessorDTO > >()
		{
				...
				AsyncCallback< PagingLoadResult< ProfessorDTO > > callback)
			{
				...
				service.getBuscaListDeslocamentoUnidades(cenario, cpf, campusDTO, display.getProfessorFiltro(),
				...
				new SelectionListener< MenuEvent >()
		{
			...
			public void componentSelected( MenuEvent ce )
			{
				...
				ExcelParametros parametros = new ExcelParametros(
					ExcelInformationType.PROFESSORES_DESLOCAMENTO_UNIDADES, instituicaoEnsinoDTO, cenario, fileExtension );
