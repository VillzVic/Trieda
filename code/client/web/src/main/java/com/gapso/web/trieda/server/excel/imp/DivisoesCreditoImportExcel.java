...
public class DivisoesCreditoImportExcel extends AbstractImportExcel<DivisoesCreditoImportExcelBean>
{
	...
	public DivisoesCreditoImportExcel(Cenario cenario, TriedaI18nConstants i18nConstants, TriedaI18nMessages i18nMessages, InstituicaoEnsino instituicaoEnsino)
	{
	...
	@Override
	protected DivisoesCreditoImportExcelBean createExcelBean(Row header, Row row)
	{
		DivisoesCreditoImportExcelBean bean = new DivisoesCreditoImportExcelBean(row.getRowNum() + 1);
	...
	@Override
	protected boolean doSyntacticValidation(List<DivisoesCreditoImportExcelBean> sheetContent)
	{
	...
	@Override
	protected boolean doLogicValidation(List<DivisoesCreditoImportExcelBean> sheetContent)
	{
	...
	private void checkUniqueness(List<DivisoesCreditoImportExcelBean> sheetContent)
	{
	...
	private void checkSomaCreditos(List<DivisoesCreditoImportExcelBean> sheetContent)
	{
	...
	@Transactional
	@Override
	protected void updateDataBase(List<DivisoesCreditoImportExcelBean> sheetContent)
	{
		Map<String, DivisaoCredito> divisoesBDMap = DivisaoCredito.buildDivisaoCreditoKeyToDivisaoCreditoMap(DivisaoCredito.findByCenario(this.instituicaoEnsino, getCenario()));
