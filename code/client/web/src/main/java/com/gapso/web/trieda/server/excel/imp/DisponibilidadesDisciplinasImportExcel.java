...
public class DisponibilidadesDisciplinasImportExcel extends AbstractImportExcel<DisponibilidadesDisciplinasImportExcelBean> {
	...
	public DisponibilidadesDisciplinasImportExcel(Cenario cenario,
	...
	protected boolean sheetMustBeProcessed(int sheetIndex, Sheet sheet, Workbook workbook) {
		...
		return ExcelInformationType.DISPONIBILIDADES_DISCIPLINAS.getSheetName().equals(sheetName);
	}
	...
	@Override
	protected DisponibilidadesDisciplinasImportExcelBean createExcelBean(Row header, Row row, int sheetIndex, Sheet sheet, Workbook workbook) {
	...
	protected void processSheetContent(String sheetName, List<DisponibilidadesDisciplinasImportExcelBean> sheetContent) {
	...
	private boolean doSyntacticValidation(String sheetName, List<DisponibilidadesDisciplinasImportExcelBean> sheetContent) {
	...
	private boolean doLogicValidation(String sheetName, List<DisponibilidadesDisciplinasImportExcelBean> sheetContent) {
	...
	@Transactional
	private void updateDataBase(String sheetName, List<DisponibilidadesDisciplinasImportExcelBean> sheetContent) {
