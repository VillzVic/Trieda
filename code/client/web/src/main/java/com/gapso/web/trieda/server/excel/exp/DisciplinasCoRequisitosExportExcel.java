...
public class DisciplinasCoRequisitosExportExcel
	extends AbstractExportExcel
{
	...
	public DisciplinasCoRequisitosExportExcel( Cenario cenario,
	...
	public DisciplinasCoRequisitosExportExcel( boolean removeUnusedSheets, Cenario cenario,
		TriedaI18nConstants i18nConstants, TriedaI18nMessages i18nMessages,
		InstituicaoEnsino instituicaoEnsino, String fileExtension )
	{
		super( true, ExcelInformationType.DISCIPLINAS_CO_REQUISITOS.getSheetName(), cenario, i18nConstants, i18nMessages, instituicaoEnsino, fileExtension );
	...
	public String getFileName() {
		return getI18nConstants().disciplinasCoRequisitos();
	}
	...
	protected boolean fillInExcel( Workbook workbook, Workbook templateWorkbook )
	{
		List< Object[] > curriculosDisciplinasPreRequisitos
			= CurriculoDisciplina.findBy(instituicaoEnsino, getCenario(), null, null,null, null,  null, "coRequisitos");
