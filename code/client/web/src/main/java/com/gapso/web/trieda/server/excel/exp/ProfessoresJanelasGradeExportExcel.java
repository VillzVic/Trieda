...
public class ProfessoresJanelasGradeExportExcel
	extends AbstractExportExcel
{
	...
	public ProfessoresJanelasGradeExportExcel( Cenario cenario, TriedaI18nConstants i18nConstants,
	...
	public ProfessoresJanelasGradeExportExcel( boolean removeUnusedSheets, Cenario cenario,
	...
	public ProfessoresJanelasGradeExportExcel( boolean removeUnusedSheets,
			Cenario cenario, TriedaI18nConstants i18nConstants,
			TriedaI18nMessages i18nMessages, ExportExcelFilter filter,
			InstituicaoEnsino instituicaoEnsino, String fileExtension )
	{
		super( true, ExcelInformationType.PROFESSORES_QUANTIDADE_JANELAS.getSheetName(), cenario, i18nConstants, i18nMessages, instituicaoEnsino, fileExtension );
	...
	{
		return getI18nConstants().professoresQuantidadeJanelas();
	}
	...
	protected boolean fillInExcel( Workbook workbook, Workbook templateWorkbook )
	{
		...
		for ( CampusDTO campusDTO : campusDTOList )
		{
			relatorioDocenteDTO.addAll(
					atendimentosServiceImpl.getProfessoresJanelasGrade(ConvertBeans.toCenarioDTO(getCenario()), campusDTO, null) );
		}
