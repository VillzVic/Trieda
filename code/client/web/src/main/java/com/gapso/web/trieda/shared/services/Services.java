...
public class Services {
	...
	public static OtimizarServiceAsync otimizar() {
		OtimizarServiceAsync service = (OtimizarServiceAsync) Registry
				.get(OTIMIZAR);
		if (service == null) {
	...
	public static UnidadesServiceAsync unidades() {
		UnidadesServiceAsync service = (UnidadesServiceAsync) Registry
				.get(UNIDADES);
		if (service == null) {
	...
	public static GruposSalasServiceAsync gruposSalas() {
		GruposSalasServiceAsync service = (GruposSalasServiceAsync) Registry
				.get(GRUPOSSALAS);
		if (service == null) {
	...
	public static DisciplinasServiceAsync disciplinas() {
		DisciplinasServiceAsync service = (DisciplinasServiceAsync) Registry
				.get(DISCIPLINAS);
		if (service == null) {
	...
	public static OfertasServiceAsync ofertas() {
		OfertasServiceAsync service = (OfertasServiceAsync) Registry
				.get(OFERTAS);
		if (service == null) {
	...
	public static DemandasServiceAsync demandas() {
		DemandasServiceAsync service = (DemandasServiceAsync) Registry
				.get(DEMANDAS);
		if (service == null) {
	...
	public static HorariosAulaServiceAsync horariosAula() {
		HorariosAulaServiceAsync service = (HorariosAulaServiceAsync) Registry
				.get(HORARIOSAULA);
		if (service == null) {
	...
	public static AreasTitulacaoServiceAsync areasTitulacao() {
		AreasTitulacaoServiceAsync service = (AreasTitulacaoServiceAsync) Registry
				.get(AREASTITULACAO);
		if (service == null) {
	...
	public static SemanasLetivaServiceAsync semanasLetiva() {
		SemanasLetivaServiceAsync service = (SemanasLetivaServiceAsync) Registry
				.get(SEMANASLETIVA);
		if (service == null) {
	...
	public static TiposCursosServiceAsync tiposCursos() {
		TiposCursosServiceAsync service = (TiposCursosServiceAsync) Registry
				.get(TIPOSCURSOS);
		if (service == null) {
	...
	public static DivisoesCreditosServiceAsync divisaoCreditos() {
		DivisoesCreditosServiceAsync service = (DivisoesCreditosServiceAsync) Registry
				.get(DIVISAOCREDITOS);
		if (service == null) {
	...
	public static ProfessoresServiceAsync professores() {
		ProfessoresServiceAsync service = (ProfessoresServiceAsync) Registry
				.get(PROFESSORES);
		if (service == null) {
	...
	public static ProfessoresDisciplinaServiceAsync professoresDisciplina() {
		ProfessoresDisciplinaServiceAsync service = (ProfessoresDisciplinaServiceAsync) Registry
				.get(PROFESSORESDISCIPLINA);
		if (service == null) {
	...
	public static EquivalenciasServiceAsync equivalencias() {
		EquivalenciasServiceAsync service = (EquivalenciasServiceAsync) Registry
				.get(EQUIVALENCIAS);
		if (service == null) {
	...
	public static FixacoesServiceAsync fixacoes() {
		FixacoesServiceAsync service = (FixacoesServiceAsync) Registry
				.get(FIXACOES);
		if (service == null) {
