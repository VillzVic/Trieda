	...
	extends AbstractImportExcel< TiposCursoImportExcelBean >
{
	...
	public TiposCursoImportExcel( Cenario cenario,
		...
		int sheetIndex, Sheet sheet, Workbook workbook )
	{
		...
		return ExcelInformationType.TIPOS_CURSO.getSheetName().equals( sheetName );
	}
	...
	@Override
	protected TiposCursoImportExcelBean createExcelBean(
		Row header, Row row, int sheetIndex,
		Sheet sheet, Workbook workbook )
	{
		TiposCursoImportExcelBean bean
			= new TiposCursoImportExcelBean( row.getRowNum() + 1 );
