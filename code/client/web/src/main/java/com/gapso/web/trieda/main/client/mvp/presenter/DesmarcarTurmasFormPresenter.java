...
public class DesmarcarTurmasFormPresenter
	implements Presenter
{
	...
	public DesmarcarTurmasFormPresenter(
			...
			new SelectionListener< ButtonEvent >()
		{
			...
			public void componentSelected( ButtonEvent ce )
			{
				if ( isValid() )
				{
					...
					service.desconfirmarTurmasComNumAlunos( getQtdeAlunos(), cenario, new AbstractAsyncCallbackWithDefaultOnFailure<Void>("Erro ao marcar as turmas",display)
					{
						@Override
						public void onSuccess( Void result )
						{
							...
							Info.display( "Salvo",
								"Turmas com menos de " + getQtdeAlunos() + " desmarcadas" );
						}
					});
				}
				else
