...
public class ProfessoresServiceImpl extends RemoteService implements
	...
	public List<HorarioDisponivelCenarioDTO> getHorariosDisponiveis(
		...
		List<HorarioDisponivelCenario> list = professor
	...
	public PagingLoadResult<ProfessorDTO> getBuscaList(String cpf,
		...
		BasePagingLoadResult<ProfessorDTO> result = new BasePagingLoadResult<ProfessorDTO>(
				list);
		result.setOffset(config.getOffset());
		result.setTotalLength(Professor.count(cpf, tipoContrato, titulacao,
				areaTitulacao));
		return result;
	}
	...
	public PagingLoadResult<ProfessorCampusDTO> getProfessorCampusList(
		...
		if (campusDTO != null && professorDTO == null)
			list = ConvertBeans.toProfessorCampusDTO(Campus.find(campusDTO
					.getId()));
		else if (campusDTO == null && professorDTO != null)
			list = ConvertBeans.toProfessorCampusDTO(Professor
					.find(professorDTO.getId()));
		else if (campusDTO == null && professorDTO == null) {
