...
public class AtendimentosFaixaDisciplinaPresenter	
	implements Presenter
{
		...
		extends ITriedaI18nGateway
	{
		...
		Grid< AtendimentoFaixaCreditoDTO > getGrid();
		ListStore< AtendimentoFaixaCreditoDTO > getStore();
	...
	public AtendimentosFaixaDisciplinaPresenter(
	...
	private void setListeners()
	{
				...
				new SelectionChangedListener< CampusDTO >()
		{
				...
				SelectionChangedEvent< CampusDTO > se )
			{
				...
				Services.atendimentos().getAtendimentosFaixaDisciplina( cenarioDTO, se.getSelectedItem(),
				new AbstractAsyncCallbackWithDefaultOnFailure< List < AtendimentoFaixaCreditoDTO > >( display )
				{
					@Override
					public void onSuccess(
						List< AtendimentoFaixaCreditoDTO > list )
						{
				...
				new SelectionListener< MenuEvent >()
		{
			...
			public void componentSelected( MenuEvent ce )
			{
				...
				ExcelParametros parametros = new ExcelParametros(
					ExcelInformationType.ATENDIMENTOS_FAIXA_DISCIPLINA, instituicaoEnsinoDTO, cenarioDTO, fileExtension );
