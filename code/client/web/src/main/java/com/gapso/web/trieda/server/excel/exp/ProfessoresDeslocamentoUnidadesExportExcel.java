...
public class ProfessoresDeslocamentoUnidadesExportExcel
	extends ProfessorListExportExcel
{

	public ProfessoresDeslocamentoUnidadesExportExcel( Cenario cenario,
	...
	public List<Professor> getProfessores() {
		...
		return professoresService.getBuscaListDeslocamentoUnidadesExport(getCenario(), 
