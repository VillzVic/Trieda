...
import com.gapso.web.trieda.main.client.mvp.presenter.SelecionarTurnosPresenter;
...
public class SelecionarTurnosView extends MyComposite implements SelecionarTurnosPresenter.Display {
	...
	private ListView<TurnoDTO> naoSelecionadoList;
	private ListView<TurnoDTO> selecionadoList;
	
	private Button adicionaBT;
	private Button removeBT;
	
	public SelecionarTurnosView() {
		initUI();
	}

	private void initUI() {
		simpleModal = new SimpleModal("Salvar","Cancelar","Selecionar Turnos",Resources.DEFAULTS.campus16());
	...
	private void createForm() {
		...
		naoSelecionadoListPanel.setHeadingHtml("Turnos não selecionados");
		naoSelecionadoListPanel.setWidth(267);
		naoSelecionadoListPanel.setHeight(320);
		naoSelecionadoList = new ListView<TurnoDTO>();
		naoSelecionadoList.setDisplayProperty(TurnoDTO.PROPERTY_DISPLAY_TEXT);
		...
		selecionadoListPanel.setHeadingHtml("Turnos selecionados");
		selecionadoListPanel.setWidth(267);
		selecionadoListPanel.setHeight(320);
		selecionadoList = new ListView<TurnoDTO>();
		selecionadoList.setDisplayProperty(TurnoDTO.PROPERTY_DISPLAY_TEXT);
	...
	@Override
	public ListView< TurnoDTO > getNaoSelecionadoList()
	{
		return naoSelecionadoList;
	}

	@Override
	public ListView< TurnoDTO > getSelecionadoList()
	{
