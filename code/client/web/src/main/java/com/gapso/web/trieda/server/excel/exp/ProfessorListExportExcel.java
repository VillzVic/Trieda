...
public abstract class ProfessorListExportExcel 
	extends AbstractExportExcel
{
	...
	protected ProfessoresListFiltroExcel filter;

	public ProfessorListExportExcel( Cenario cenario,
	...
	public ProfessorListExportExcel( boolean removeUnusedSheets, Cenario cenario,
		TriedaI18nConstants i18nConstants, TriedaI18nMessages i18nMessages,
		InstituicaoEnsino instituicaoEnsino, String fileExtension )
	{
	...
	public ProfessorListExportExcel(boolean b, String sheetName, Cenario cenario, TriedaI18nConstants i18nConstants, ExportExcelFilter filter,
			TriedaI18nMessages i18nMessages, InstituicaoEnsino instituicaoEnsino, String fileExtension) {
		super( b, sheetName, cenario, i18nConstants, i18nMessages, instituicaoEnsino, fileExtension );
	...
	public abstract List<Professor> getProfessores();
	...
	public ProfessoresListFiltroExcel getFilter()
	{
		return filter;
	}
	...
	{
		if ( filter != null && filter instanceof ProfessoresListFiltroExcel )
		{
			this.filter = (ProfessoresListFiltroExcel) filter;
		}
		else
		{
			this.filter = null;
