...
public class ResumoCenarioExportExcel
	extends AbstractExportExcel
{
	...
	public ResumoCenarioExportExcel( Cenario cenario,
	...
	public ResumoCenarioExportExcel( boolean removeUnusedSheets, Cenario cenario,
		TriedaI18nConstants i18nConstants, TriedaI18nMessages i18nMessages,
		InstituicaoEnsino instituicaoEnsino, String fileExtension )
	{
		super( true, ExcelInformationType.RESUMO_CENARIO.getSheetName(), cenario, i18nConstants, i18nMessages, instituicaoEnsino, fileExtension );
	...
	public String getFileName() {
		return getI18nConstants().resumoCenario();
	}
