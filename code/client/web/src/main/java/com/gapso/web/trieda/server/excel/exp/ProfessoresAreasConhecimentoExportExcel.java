...
public class ProfessoresAreasConhecimentoExportExcel
	extends AbstractExportExcel
{
	...
	public ProfessoresAreasConhecimentoExportExcel( Cenario cenario, TriedaI18nConstants i18nConstants,
	...
	public ProfessoresAreasConhecimentoExportExcel( boolean removeUnusedSheets, Cenario cenario,
	...
	public ProfessoresAreasConhecimentoExportExcel( boolean removeUnusedSheets,
			Cenario cenario, TriedaI18nConstants i18nConstants,
			TriedaI18nMessages i18nMessages, ExportExcelFilter filter,
			InstituicaoEnsino instituicaoEnsino, String fileExtension )
	{
		super( true, ExcelInformationType.PROFESSORES_AREAS_CONHECIMENTO.getSheetName(), cenario, i18nConstants, i18nMessages, instituicaoEnsino, fileExtension );
	...
	{
		return getI18nConstants().professoresAreasConhecimento();
	}
