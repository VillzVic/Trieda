...
public class DisciplinaCoRequisitoFormPresenter
implements Presenter
{
	public interface Display
	{
		...
		DisciplinaAutoCompleteBox getDisciplinaCoRequisitoComboBox();
	}
	...
	public DisciplinaCoRequisitoFormPresenter(
		...
		display.getSalvarButton().addSelectionListener(new SelectionListener<ButtonEvent>(){
			...
			public void componentSelected(ButtonEvent ce) {
				if(isValid()) {
					...
					service.saveDisciplinaCoRequisito(cenario, getDTO(), display.getDisciplinaCoRequisitoComboBox().getValue(),
	...
	private DisciplinaRequisitoDTO getDTO()
	{
		...
		disciplinaRequisitoDTO.setDisciplinaRequisitoId(display.getDisciplinaCoRequisitoComboBox().getValue().getId());
		disciplinaRequisitoDTO.setDisciplinaRequisitoString(display.getDisciplinaCoRequisitoComboBox().getValue().getCodigo());
