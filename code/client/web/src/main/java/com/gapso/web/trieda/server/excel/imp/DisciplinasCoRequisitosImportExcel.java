...
public class DisciplinasCoRequisitosImportExcel extends AbstractImportExcel<DisciplinasRequisitosImportExcelBean>
{
	...
	public DisciplinasCoRequisitosImportExcel(Cenario cenario, TriedaI18nConstants i18nConstants, TriedaI18nMessages i18nMessages, InstituicaoEnsino instituicaoEnsino)
	{
	...
	{
		return ExcelInformationType.DISCIPLINAS_CO_REQUISITOS.getSheetName();
	}
