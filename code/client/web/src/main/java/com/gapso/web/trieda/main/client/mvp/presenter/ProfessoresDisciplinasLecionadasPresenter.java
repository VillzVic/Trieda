...
public class ProfessoresDisciplinasLecionadasPresenter	
	implements Presenter
{
	...
	public ProfessoresDisciplinasLecionadasPresenter(
	...
	private void setListeners()
	{
				...
				new SelectionChangedListener< CampusDTO >()
		{
				...
				SelectionChangedEvent< CampusDTO > se )
			{
				...
				Services.atendimentos().getProfessoresDisciplinasLecionadas( cenarioDTO, se.getSelectedItem(),
				...
				new SelectionListener< MenuEvent >()
		{
			...
			public void componentSelected( MenuEvent ce )
			{
				...
				ExcelParametros parametros = new ExcelParametros(
					ExcelInformationType.PROFESSORES_DISCIPLINAS_LECIONADAS, instituicaoEnsinoDTO, fileExtension );
		...
		display.getResetBuscaButton().addSelectionListener(
				new SelectionListener< ButtonEvent >()
			{
				...
				public void componentSelected( ButtonEvent ce )
				{
					...
					display.getGrid().mask( display.getI18nMessages().loading() );
					Services.atendimentos().getProfessoresDisciplinasLecionadas( cenarioDTO, display.getCampusComboBox().getValue(),
							display.getTipoProfessorComboBox().getValue(),
							new AbstractAsyncCallbackWithDefaultOnFailure< List < RelatorioQuantidadeDTO > >( display )
					{
						@Override
