...
public class AtendimentosFaixaCreditoView extends MyComposite
	implements AtendimentosFaixaCreditoPresenter.Display
{
	...
	public AtendimentosFaixaCreditoView(CenarioDTO cenarioDTO)
	{
	...
	private void createTabItem()
	{
		tabItem = new GTabItem(
			"Atendimentos por Faixa de Crédito", Resources.DEFAULTS.divisaoDeCreditos16() );
	...
	public List< ColumnConfig > getColumnList()
	{
		...
		list.add( new ColumnConfig( AtendimentoFaixaCreditoDTO.PROPERTY_FAIXA_CREDITO, "Faixa de Atendimento por Créditos", 240 ) );
		list.add( createIntegerColumnConfig( AtendimentoFaixaCreditoDTO.PROPERTY_CREDITOS_DEMANDADOS_P1, "Créditos Demandados P1", 140 ) );
		list.add( createIntegerColumnConfig( AtendimentoFaixaCreditoDTO.PROPERTY_CREDITOS_ATENDIDOS_P1, "Créditos Atendidos P1", 140 ) );
		list.add( createIntegerColumnConfig( AtendimentoFaixaCreditoDTO.PROPERTY_QUANTIDADE_ALUNOS, "Quantidade de Alunos", 140 ) );
		list.add( createIntegerColumnConfig( AtendimentoFaixaCreditoDTO.PROPERTY_CREDITOS_DEMANDADOS_P2, "Créditos Demandados P2", 140 ) );
