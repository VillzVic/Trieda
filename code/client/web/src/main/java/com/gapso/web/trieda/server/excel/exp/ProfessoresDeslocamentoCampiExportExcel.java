...
public class ProfessoresDeslocamentoCampiExportExcel
	extends ProfessorListExportExcel
{

	public ProfessoresDeslocamentoCampiExportExcel( Cenario cenario,
	...
	public List<Professor> getProfessores() {
		...
		return professoresService.getBuscaListDeslocamentoCampiExport(getCenario(), 
