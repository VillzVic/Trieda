...
public class AtendimentosFaixaCreditoPresenter
	implements Presenter
{
	...
	public AtendimentosFaixaCreditoPresenter(
	...
	private void setListeners()
	{
				...
				new SelectionChangedListener< CampusDTO >()
		{
				...
				SelectionChangedEvent< CampusDTO > se )
			{
				...
				Services.atendimentos().getAtendimentosFaixaCredito( cenarioDTO, se.getSelectedItem(),
