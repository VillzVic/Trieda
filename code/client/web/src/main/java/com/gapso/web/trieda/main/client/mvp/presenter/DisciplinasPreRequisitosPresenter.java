...
import com.gapso.web.trieda.main.client.mvp.view.DisciplinaPreRequisitoFormView;
...
public class DisciplinasPreRequisitosPresenter
	implements Presenter
{
	...
	public DisciplinasPreRequisitosPresenter(
	...
	private void configureProxy()
	{
			...
			new RpcProxy< PagingLoadResult< DisciplinaRequisitoDTO > >()
		{
				...
				AsyncCallback< PagingLoadResult< DisciplinaRequisitoDTO > > callback )
			{
				...
				service.getDisciplinasPreRequisitosList( cenario, disciplinaDTO, curriculoDTO, periodo,
	...
	private void setListeners()
	{
			...
			new SelectionListener< ButtonEvent >()
		{
			...
			{
				Presenter presenter = new DisciplinaPreRequisitoFormPresenter( instituicaoEnsinoDTO, cenario,
					new DisciplinaPreRequisitoFormView( cenario ),  display.getGrid());
			...
			new SelectionListener< ButtonEvent >()
		{
			...
			public void componentSelected( ButtonEvent ce )
			{
				...
				service.removeDisciplinasPreRequisitos( cenario, list, new AsyncCallback< Void >()
				{
					@Override
					public void onFailure( Throwable caught )
					{
						MessageBox.alert( "ERRO!", "Não foi possível remover o(s) pre-requisito(s)", null );
					}
