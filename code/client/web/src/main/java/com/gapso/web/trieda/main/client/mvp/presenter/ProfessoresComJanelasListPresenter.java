...
public class ProfessoresComJanelasListPresenter
	extends ProfessoresListPresenter 
{

	public ProfessoresComJanelasListPresenter(
	...
	protected void configureProxy() {
			...
			new RpcProxy< PagingLoadResult< ProfessorDTO > >()
		{
				...
				AsyncCallback< PagingLoadResult< ProfessorDTO > > callback)
			{
				...
				service.getBuscaListComJanelas(cenario, cpf, campusDTO, display.getProfessorFiltro(), (PagingLoadConfig) loadConfig, callback);
			}
		};
				...
				new SelectionListener< MenuEvent >()
		{
			...
			public void componentSelected( MenuEvent ce )
			{
				...
				ExcelParametros parametros = new ExcelParametros(
					ExcelInformationType.PROFESSORES_JANELAS, instituicaoEnsinoDTO, cenario, fileExtension );
