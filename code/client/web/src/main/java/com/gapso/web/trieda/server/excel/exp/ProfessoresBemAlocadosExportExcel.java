...
public class ProfessoresBemAlocadosExportExcel
	extends ProfessorListExportExcel
{

	public ProfessoresBemAlocadosExportExcel( Cenario cenario,
	...
	public List<Professor> getProfessores() {
		...
		return professoresService.getBuscaListBemAlocadosExport(getCenario(), 
