...
public class ProfessoresDisciplinasHabilitadasView extends MyComposite
	implements ProfessoresDisciplinasHabilitadasPresenter.Display
{
	...
	private void createTabItem()
	{
		tabItem = new GTabItem(
			"Professores por Quantidade de Disciplinas Habilitadas", Resources.DEFAULTS.resumoDisciplinas16() );
