...
public class ProfessoresTitulacoesView extends MyComposite
	implements ProfessoresTitulacoesPresenter.Display
{
	...
	public ProfessoresTitulacoesView(CenarioDTO cenarioDTO)
	{
	...
	private void createTabItem()
	{
		tabItem = new GTabItem(
			"Professores por Titulações", Resources.DEFAULTS.tipoCurso16() );
