...
public class ProfessoresJanelasGradePresenter
	implements Presenter
{
	...
	public ProfessoresJanelasGradePresenter(
	...
	private void setListeners()
	{
				...
				new SelectionChangedListener< CampusDTO >()
		{
				...
				SelectionChangedEvent< CampusDTO > se )
			{
				...
				Services.atendimentos().getProfessoresJanelasGrade( cenarioDTO, se.getSelectedItem(), null,
				...
				new SelectionListener< MenuEvent >()
		{
			...
			public void componentSelected( MenuEvent ce )
			{
				...
				ExcelParametros parametros = new ExcelParametros(
					ExcelInformationType.PROFESSORES_QUANTIDADE_JANELAS, instituicaoEnsinoDTO, fileExtension );
			...
			new SelectionListener< ButtonEvent >()
		{
			...
			public void componentSelected( ButtonEvent ce )
			{
				...
				display.getGrid().mask( display.getI18nMessages().loading() );
				Services.atendimentos().getProfessoresJanelasGrade( cenarioDTO, display.getCampusComboBox().getValue(),
