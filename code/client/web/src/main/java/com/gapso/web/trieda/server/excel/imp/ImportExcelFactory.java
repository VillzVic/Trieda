...
public class ImportExcelFactory
{
		...
		TriedaI18nMessages i18nMessages, InstituicaoEnsino instituicaoEnsino )
	{
		...
		switch ( informationToBeImported )
		{
			...
			case DISCIPLINAS: importer = new MultiImportExcel( cenario, i18nConstants, i18nMessages, instituicaoEnsino, new Class[]{DisciplinasImportExcel.class,DisponibilidadesDisciplinasImportExcel.class} ); break;
			...
			case SALAS: importer = new MultiImportExcel( cenario, i18nConstants, i18nMessages, instituicaoEnsino, new Class[]{SalasImportExcel.class,DisponibilidadesSalasImportExcel.class} ); break;
			case OFERTAS_CURSOS_CAMPI: importer = new OfertasCursosCampiImportExcel( cenario, i18nConstants, i18nMessages, instituicaoEnsino ); break;
			...
			case CAMPI_DESLOCAMENTO: importer = new CampiDeslocamentoImportExcel( cenario, i18nConstants, i18nMessages, instituicaoEnsino ); break;
