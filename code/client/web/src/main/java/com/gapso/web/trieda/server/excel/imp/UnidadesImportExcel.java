...
public class UnidadesImportExcel extends AbstractImportExcel<UnidadesImportExcelBean>
{
	...
	public UnidadesImportExcel(Cenario cenario, TriedaI18nConstants i18nConstants, TriedaI18nMessages i18nMessages, InstituicaoEnsino instituicaoEnsino)
	{
	...
	@Override
	protected UnidadesImportExcelBean createExcelBean(Row header, Row row)
	{
	...
	@Override
	protected boolean doSyntacticValidation(List<UnidadesImportExcelBean> sheetContent)
	{
	...
	@Override
	protected boolean doLogicValidation(List<UnidadesImportExcelBean> sheetContent)
	{
	...
	@Transactional
	@Override
	protected void updateDataBase(List<UnidadesImportExcelBean> sheetContent)
	{
		Map<String, Unidade> unidadesBDMap = Unidade.buildUnidadeCodigoToUnidadeMap(Unidade.findByCenario(this.instituicaoEnsino, getCenario()));
