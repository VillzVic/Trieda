...
import com.gapso.web.trieda.main.client.mvp.presenter.DivisaoCreditosAssociarDisciplinaFormPresenter;
...
public class DivisaoCreditosAssociarDisciplinaFormView	extends MyComposite
	implements DivisaoCreditosAssociarDisciplinaFormPresenter.Display
{
	...
	public DivisaoCreditosAssociarDisciplinaFormView(
		CenarioDTO cenarioDTO, DivisaoCreditoDTO divisaoCreditoDTO,
	...
	private void initUI()
	{
		String title = ( ( this.divisaoCreditoDTO.getId() == null ) ?
			"Inserir Regra de Crédito para Disciplina" :
			"Editar Regra de Crédito para Disciplina (" + this.divisaoCreditoDTO.getDisciplinaString() + ")" );
	
		this.simpleModal = new SimpleModal(
			title, Resources.DEFAULTS.divisaoCreditoDisciplina16() );
	...
	private void createForm()
	{
		...
		this.disciplinaCB = new DisciplinaAutoCompleteBox(cenarioDTO);
		this.disciplinaCB.setAllowBlank(false);
		this.disciplinaCB.setValue(disciplinaDTO);
	...
	public boolean isValid()
	{
		...
		return ( this.formPanel.isValid() && totalCreditos == this.disciplinaCB.getValue().getTotalCreditos() );
	}
