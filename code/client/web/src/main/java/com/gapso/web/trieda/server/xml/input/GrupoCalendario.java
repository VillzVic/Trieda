...
/**
 * <p>Java class for GrupoCalendario complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GrupoCalendario">
 *   &lt;complexContent>
...
@XmlType(name = "GrupoCalendario", propOrder = {
    "calendario"
})
public class GrupoCalendario {

    @XmlElement(name = "Calendario")
    protected List<ItemCalendario> calendario;
     ...
     * 
     */
    public List<ItemCalendario> getCalendario() {
        if (calendario == null) {
            calendario = new ArrayList<ItemCalendario>();
        }
