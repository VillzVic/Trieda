...
public class AmbientesFaixaUtilizacaoHorariosPresenter	
	implements Presenter
{
	...
	public AmbientesFaixaUtilizacaoHorariosPresenter(
	...
	private void setListeners()
	{
				...
				new SelectionChangedListener< CampusDTO >()
		{
				...
				SelectionChangedEvent< CampusDTO > se )
			{
				...
				Services.atendimentos().getAmbientesFaixaOcupacaoHorarios( cenarioDTO, se.getSelectedItem(),
				...
				new SelectionListener< MenuEvent >()
		{
			...
			public void componentSelected( MenuEvent ce )
			{
				...
				ExcelParametros parametros = new ExcelParametros(
					ExcelInformationType.AMBIENTES_FAIXA_UTILIZACAO, instituicaoEnsinoDTO, cenarioDTO, fileExtension );
