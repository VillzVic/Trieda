...
import com.gapso.web.trieda.main.client.mvp.presenter.AmbientesFaixaOcupacaoDiaSemanaPresenter;
...
public class AmbientesFaixaOcupacaoDiaSemanaView extends MyComposite
	implements AmbientesFaixaOcupacaoDiaSemanaPresenter.Display
{
	...
	public AmbientesFaixaOcupacaoDiaSemanaView(CenarioDTO cenarioDTO)
	{
	...
	private void initUI()
	{
		...
		panel.setHeadingHtml( cenarioDTO.getNome() + " » Ocupação dos Ambientes por Dia da Semana" );
	}
	
	private void createTabItem()
	{
		tabItem = new GTabItem(
			"Ocupação dos Ambientes por Dia da Semana", Resources.DEFAULTS.sala16() );
    ...
    public ChartModel getChartModel() {  
      ChartModel cm = new ChartModel("Ocupação por Semana",  
