...
public class GrupoAtendimentoHorarioAulaSolucao {

    @XmlElement(name = "AtendimentoHorarioAula")
    protected List<ItemAtendimentoHorarioAulaSolucao> atendimentoHorarioAula;
     ...
     * {@link ItemAtendimentoHorarioAulaSolucao }
     * 
     * 
     */
    public List<ItemAtendimentoHorarioAulaSolucao> getAtendimentoHorarioAula() {
        if (atendimentoHorarioAula == null) {
            atendimentoHorarioAula = new ArrayList<ItemAtendimentoHorarioAulaSolucao>();
        }
