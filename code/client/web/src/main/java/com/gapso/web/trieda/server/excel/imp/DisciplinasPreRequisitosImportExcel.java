...
public class DisciplinasPreRequisitosImportExcel
	extends AbstractImportExcel< DisciplinasRequisitosImportExcelBean >
{
	...
	public DisciplinasPreRequisitosImportExcel( Cenario cenario,
		...
		int sheetIndex, Sheet sheet, Workbook workbook )
	{
		...
		return ExcelInformationType.DISCIPLINAS_PRE_REQUISITOS.getSheetName().equals( sheetName );
	}
