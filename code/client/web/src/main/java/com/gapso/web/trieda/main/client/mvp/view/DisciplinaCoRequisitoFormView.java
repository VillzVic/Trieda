...
import com.gapso.web.trieda.main.client.mvp.presenter.DisciplinaCoRequisitoFormPresenter;
...
public class DisciplinaCoRequisitoFormView	extends MyComposite
	implements DisciplinaCoRequisitoFormPresenter.Display
{
	...
	private DisciplinaAutoCompleteBox disciplinaCoRequisitoCB;
	private CenarioDTO cenarioDTO;
	
	public DisciplinaCoRequisitoFormView( CenarioDTO cenarioDTO )
	{
	...
	private void initUI() {
		String title = "Inserção de Disciplina Co-Requisito";
	...
	private void createForm() {
		...
		disciplinaCoRequisitoCB = new DisciplinaAutoCompleteBox( cenarioDTO );
		disciplinaCoRequisitoCB.setFieldLabel("Disciplina Co-Requisito");
		disciplinaCoRequisitoCB.setAllowBlank(false);
		formPanel.add(disciplinaCoRequisitoCB, formData);
	...
	@Override
	public DisciplinaAutoCompleteBox getDisciplinaCoRequisitoComboBox() {
		return disciplinaCoRequisitoCB;
	}
}