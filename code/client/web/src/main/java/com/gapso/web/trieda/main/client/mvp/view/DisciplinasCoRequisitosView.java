...
import com.gapso.web.trieda.main.client.mvp.presenter.DisciplinasCoRequisitosPresenter;
...
public class DisciplinasCoRequisitosView 
	extends MyComposite
	implements DisciplinasCoRequisitosPresenter.Display
{
	...
	public DisciplinasCoRequisitosView( CenarioDTO cenarioDTO )
	{
	...
	private void createTabItem()
	{
		this.tabItem = new GTabItem(
			"Disciplinas Co-Requisitos", Resources.DEFAULTS.disciplinaCurriculo16() );
	...
	public List< ColumnConfig > getColumnList()
	{
		...
		list.add( new ColumnConfig( DisciplinaRequisitoDTO.PROPERTY_DISCIPLINA_REQUISITO_STRING, getI18nConstants().codigoDisciplinaCoRequisito(), 200 ) );
