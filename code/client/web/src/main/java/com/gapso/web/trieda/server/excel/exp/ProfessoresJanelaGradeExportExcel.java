...
public class ProfessoresJanelaGradeExportExcel
	extends ProfessorListExportExcel{

	public ProfessoresJanelaGradeExportExcel( Cenario cenario,
	...
	public List<Professor> getProfessores() {
		...
		return professoresService.getBuscaListComJanelasExport(getCenario(), 
