...
public class ProfessoresGradeCheiaExportExcel
	extends ProfessorListExportExcel
{

	public ProfessoresGradeCheiaExportExcel( Cenario cenario,
	...
	public List<Professor> getProfessores() {
		...
		return professoresService.getBuscaListGradeCheiaExport(getCenario(), 
