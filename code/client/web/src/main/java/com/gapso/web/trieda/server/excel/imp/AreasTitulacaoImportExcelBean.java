...
public class AreasTitulacaoImportExcelBean extends AbstractImportExcelBean implements Comparable<AreasTitulacaoImportExcelBean> {
	...
	public List<ImportExcelError> checkSyntacticErrors() {
		...
		if (!tudoVazio()) {
			checkMandatoryField(codigoStr,ImportExcelError.AREA_TITULACAO_CODIGO_VAZIO,erros);
		} else {
