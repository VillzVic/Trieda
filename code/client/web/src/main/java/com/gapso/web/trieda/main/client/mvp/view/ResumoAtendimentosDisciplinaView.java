	...
	implements ResumoAtendimentosDisciplinaPresenter.Display
{
	...
	public ResumoAtendimentosDisciplinaView( CenarioDTO cenarioDTO )
	{
	...
	private void initUI()
	{
		...
		panel.setHeadingHtml( cenarioDTO.getNome() + " » Resumo de Atendimentos por Disciplina" );
	}
	...
	private void createGrid()
	{
	    ...
	    this.gridPanel = new SimpleGrid< ResumoMatriculaDTO >( getColumnList(), this, this.toolBar );
