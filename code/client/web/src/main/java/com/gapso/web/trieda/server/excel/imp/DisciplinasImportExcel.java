...
public class DisciplinasImportExcel extends AbstractImportExcel<DisciplinasImportExcelBean>
{
	...
	public DisciplinasImportExcel(Cenario cenario, TriedaI18nConstants i18nConstants, TriedaI18nMessages i18nMessages, InstituicaoEnsino instituicaoEnsino)
	{
	...
	@Override
	protected DisciplinasImportExcelBean createExcelBean(Row header, Row row)
	{
	...
	@Override
	protected boolean doSyntacticValidation(List<DisciplinasImportExcelBean> sheetContent)
	{
	...
	@Override
	protected boolean doLogicValidation(List<DisciplinasImportExcelBean> sheetContent)
	{
	...
	private void checkNonRegisteredTipoDisciplina(List<DisciplinasImportExcelBean> sheetContent)
	{
		...
		Map<String, TipoDisciplina> tiposDisciplinaBDMap = TipoDisciplina.buildTipoDisciplinaNomeToTipoDisciplinaMap(TipoDisciplina.findByCenario(this.instituicaoEnsino, getCenario()));
	...
	@Override
	protected void updateDataBase(List<DisciplinasImportExcelBean> sheetContent)
	{
		...
		/*
		 * if (!persistedDisciplinas.isEmpty()) { List<SemanaLetiva> semanasLetivas = SemanaLetiva.findByCenario(instituicaoEnsino, getCenario());
