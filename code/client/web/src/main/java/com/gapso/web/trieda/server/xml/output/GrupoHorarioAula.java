...
public class GrupoHorarioAula {
    ...
    protected List<Integer> horarioAulaId;
     ...
     * 
     */
    public List<Integer> getHorarioAulaId() {
        if (horarioAulaId == null) {
            horarioAulaId = new ArrayList<Integer>();
        }
        return this.horarioAulaId;
    }
