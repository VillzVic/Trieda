...
public class AmbientesFaixaUtilizacaoHorariosExportExcel
	extends AbstractExportExcel
{
	...
	public AmbientesFaixaUtilizacaoHorariosExportExcel( Cenario cenario, TriedaI18nConstants i18nConstants,
	...
	public AmbientesFaixaUtilizacaoHorariosExportExcel( boolean removeUnusedSheets, Cenario cenario,
	...
	public AmbientesFaixaUtilizacaoHorariosExportExcel( boolean removeUnusedSheets,
			Cenario cenario, TriedaI18nConstants i18nConstants,
			TriedaI18nMessages i18nMessages, ExportExcelFilter filter,
			InstituicaoEnsino instituicaoEnsino, String fileExtension )
	{
		super( true, ExcelInformationType.AMBIENTES_FAIXA_UTILIZACAO.getSheetName(), cenario, i18nConstants, i18nMessages, instituicaoEnsino, fileExtension );
	...
	{
		return getI18nConstants().ambientesFaixaOcupacao();
	}
	...
	protected boolean fillInExcel( Workbook workbook )
	{
		...
		for ( CampusDTO campusDTO : campusDTOList )
		{
			relatorioDocenteDTO.addAll(
					atendimentosServiceImpl.getAmbientesFaixaOcupacaoHorarios(ConvertBeans.toCenarioDTO(getCenario()), campusDTO) );
		}
	...
	private int writeData( RelatorioQuantidadeDTO relatorioDocenteDTO, int row, Sheet sheet )
	{
		...
		// Quantidade de Ambientes Externos
		setCell( row, i++, sheet,
				cellStyles[ ExcelCellStyleReference.INTEGER.ordinal() ],
