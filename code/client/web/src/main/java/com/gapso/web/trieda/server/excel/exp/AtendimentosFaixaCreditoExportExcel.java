...
public class AtendimentosFaixaCreditoExportExcel
	extends AbstractExportExcel
{
	...
	public AtendimentosFaixaCreditoExportExcel( Cenario cenario, TriedaI18nConstants i18nConstants,
	...
	public AtendimentosFaixaCreditoExportExcel( boolean removeUnusedSheets, Cenario cenario,
	...
	public AtendimentosFaixaCreditoExportExcel( boolean removeUnusedSheets,
			Cenario cenario, TriedaI18nConstants i18nConstants,
			TriedaI18nMessages i18nMessages, ExportExcelFilter filter,
			InstituicaoEnsino instituicaoEnsino, String fileExtension )
	{
		super( true, ExcelInformationType.ATENDIMENTOS_FAIXA_CREDITO.getSheetName(), cenario, i18nConstants, i18nMessages, instituicaoEnsino, fileExtension );
	...
	{
		return getI18nConstants().atendimentosFaixaCredito();
	}
	...
	protected boolean fillInExcel( Workbook workbook )
	{
		...
		for ( CampusDTO campusDTO : campusDTOList )
		{
			resumoFaixaCreditoDTO.addAll(
					atendimentosServiceImpl.getAtendimentosFaixaCredito(ConvertBeans.toCenarioDTO(getCenario()), campusDTO) );
		}
	...
	private int writeData( AtendimentoFaixaCreditoDTO resumoFaixaCreditoDTO, int row, Sheet sheet )
	{
		...
		// Creditos Demandados P1
		setCell( row, i++, sheet,
				cellStyles[ ExcelCellStyleReference.INTEGER.ordinal() ],
				resumoFaixaCreditoDTO.getCreditosDemandadosP1() );
		
		// Creditos Atendidos P1
		setCell( row, i++, sheet,
				cellStyles[ ExcelCellStyleReference.INTEGER.ordinal() ],
				resumoFaixaCreditoDTO.getCreditosAtendidosP1() );
		
		// Quantidade Alunos 
		setCell( row, i++, sheet,
				cellStyles[ ExcelCellStyleReference.INTEGER.ordinal() ],
				resumoFaixaCreditoDTO.getQuantidadeAlunos() );
		
		// Creditos Demandados P2
		setCell( row, i++, sheet,
				cellStyles[ ExcelCellStyleReference.INTEGER.ordinal() ],
