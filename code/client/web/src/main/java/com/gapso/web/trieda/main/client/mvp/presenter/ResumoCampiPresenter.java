	...
	implements Presenter
{
	...
	public ResumoCampiPresenter( InstituicaoEnsinoDTO instituicaoEnsinoDTO,
	...
	private void setListeners()
	{
		this.display.getExportXlsExcelButton().addSelectionListener(new SelectionListener<MenuEvent>() {
			...
			public void componentSelected( MenuEvent ce ) {
				...
				ExcelParametros parametros = new ExcelParametros(ExcelInformationType.RESUMO_CAMPI,instituicaoEnsinoDTO, cenario, fileExtension);
