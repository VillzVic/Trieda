...
public class CampusProfessorCrudModel extends AbstractCrudModel {

	@Override
	public String getServiceId() {
		return Services.CAMPIPROFESSORES;
	}
	...
	public List<Button> getExtrasButtons() {
		...
		bt1.setData("event", AppEvents.CampusProfessorView);
		bt1.setToolTip("Definir Campi/Professores");
		buttons.add(bt1);
