...
//	  C_DEMANDA_DISC_ALUNO = 4,						// Restricao 1.2.5	  
      ...
      C_SALA_TURMA = 30,
      C_SALA_UNICA_TURMA = 31,
	  C_AULA_PT_SEQUENCIAL = 32,
	  C_ALOC_MIN_ALUNO = 33,
	  C_DISC_PRATICA_TEORICA_1xN = 34
   };
   ...
   */
   ...
   void setDateTime ( DateTime * dt ) { dateTime = dt; }
   ...
   void setDateTimeInicial ( DateTime * dt ) { dateTimeI = dt; }
   void setDateTimeFinal ( DateTime * dt ) { dateTimeF = dt; }
