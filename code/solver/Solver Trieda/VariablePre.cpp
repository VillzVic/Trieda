...
VariablePre & VariablePre::operator = ( const VariablePre & var )
{
   ...
   this->calendario = var.getCalendario();
   this->parAlunos = var.getParAlunos();
   this->turno = var.getTurno();
   this->turnoIES = var.getTurnoIES();
...
bool VariablePre::operator < ( const VariablePre & var ) const
{
   ...
   if ( E_MENOR( this->getCalendario(),var.getCalendario() ) ) return true;
   if ( E_MENOR( var.getCalendario(), this->getCalendario() ) ) return false;
   ...
   if ( this->getTurno() > var.getTurno() ) return false;
   
   if ( E_MENOR( this->getTurnoIES(),var.getTurnoIES() ) ) return true;
   if ( E_MENOR( var.getTurnoIES(), this->getTurnoIES() ) ) return false;
...
std::string VariablePre::toString()
{
   ...
   switch( type )
   {
    ...
    case V_PRE_CRED_SALA_F3:
       str <<"xcs3"; break;
    case V_PRE_CRED_SALA_F4:
       str <<"xcs4"; break;
	case V_PRE_SLACK_DISC_SALA:
       str <<"fs"; break;
	case V_PRE_ALUNO_SALA:
       str <<"as"; break;
	case V_PRE_FORMANDOS_NA_TURMA:
       str <<"f"; break;
	case V_PRE_TURMA_CALENDARIO:
       str <<"v"; break;	   
	case V_PRE_NRO_ALUNOS:
       str <<"n"; break;	   
	case V_PRE_NRO_ALUNOS_OFT:
       str <<"no"; break;   
	case V_PRE_SLACK_DEMANDA_OFERTA:
       str <<"fd"; break;   
   case V_PRE_TURMA_SAB:
      str <<"sab"; break;   
   case V_PRE_ALUNOS_MESMA_TURMA_PRAT:
      str <<"ss"; break;	   
   case V_PRE_FOLGA_ALUNO_MIN_ATEND1:
      str <<"fmd1"; break;	   
   case V_PRE_FOLGA_ALUNO_MIN_ATEND2:
      str <<"fmd2"; break;	 
   case V_PRE_FOLGA_ALUNO_MIN_ATEND3:
      str <<"fmd3"; break;	 
   case V_PRE_FOLGA_OCUPA_SALA:
      str <<"fos"; break;	   	  	  
   case V_PRE_OFERECIMENTO_TURNO:
      str <<"q"; break;	   	  	  
   case V_PRE_USA_DISCIPLINA:
      str <<"k"; break;	   	  		  
   case V_PRE_TURMA_TURNOIES:
      str <<"v"; break;	
   case V_PRE_UNID_PERIODO:
      str <<"uu"; break;	
   case V_PRE_SALA_PERIODO:
      str <<"us"; break;	
   case V_PRE_FOLGA_UNID_PERIODO:
      str <<"fuu"; break;	
   case V_PRE_FOLGA_SALA_PERIODO:
      str <<"fus"; break;	
   case V_PRE_DISTRIB_ALUNOS:
      str <<"da"; break;	
   case V_PRE_SLACK_PROF:
      str <<"fp"; break;	
