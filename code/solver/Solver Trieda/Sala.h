...
public:
	...
	GGroup< HorarioDia*, LessPtr<HorarioDia> > getHorariosDiaOcupados() const { return horariosDiaOcupados; }
	...
	int somaTempo( GGroup< HorarioDia *, LessPtr< HorarioDia > > horariosDia);
