...
bool SolucaoInicialOperacional::alocaAula(vector<Aula*>::iterator itHorariosProf,
										  int totalHorariosConsiderados, Professor & professor, Aula & aula)
{
   ...
   for(int horario = 0; horario < totalHorariosConsiderados;
