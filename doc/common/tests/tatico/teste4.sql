...
INSERT INTO `atendimento_tatico` (`att_id`,`att_cred_pratico`,`att_cred_teorico`,`att_quantidade`,`semana`,`turma`,`version`,`cen_id`,`dis_id`,`ofe_id`,`sal_id`) VALUES 
 (86,2,0,40,2,'TURMA0',0,1,37,10,18),
 (87,0,2,40,0,'TURMA0',0,1,39,10,18),
 (88,0,2,40,3,'TURMA0',0,1,41,10,18),
 (89,0,2,40,4,'TURMA0',0,1,38,10,18),
 (90,0,2,40,1,'TURMA0',0,1,40,10,18);
...
INSERT INTO `disciplinas` (`dis_id`,`dis_codigo`,`dis_cred_pratico`,`dis_cred_teorico`,`dificuldade`,`dis_laboratorio`,`dis_max_alun_pratico`,`dis_max_alun_teorico`,`dis_nome`,`version`,`cen_id`,`dcr_id`,`tdi_id`) VALUES 
 (37,'1',2,0,0,0x01,40,0,'Disciplina1',8,1,NULL,1),
...
CREATE TABLE `ofertas` (
  ...
  `crc_id` bigint(20) NOT NULL,
  `tur_id` bigint(20) NOT NULL,
  `ofe_receita` double DEFAULT NULL,
  PRIMARY KEY (`cac_id`),
...
INSERT INTO `ofertas` (`cac_id`,`version`,`cam_id`,`crc_id`,`tur_id`,`ofe_receita`) VALUES 
 (10,2,8,11,6,NULL);
...
INSERT INTO `parametros` (`par_id`,`par_alunoperiodosala`,`par_alunomuitoscampi`,`par_areatitprofcur`,`par_avaliacaodesemprof`,`par_cargahorariaaluno`,`par_cargahorariaalunosel`,`par_cargahorariaprof`,`par_cargahorariaprofsel`,`par_compdisccampi`,`par_compatdiscdia`,`par_considerar_equiv`,`par_evitarredcargahorprof`,`par_evitarredcargahorprofvalue`,`par_evitarultimoprihorprof`,`par_funcaoobjetivo`,`par_limmaxdiscpro`,`par_maxnotaavalcordoc`,`par_minalunturma`,`par_minalunturmavalue`,`par_mincustdoccur`,`par_mindeslaluno`,`par_mindeslprof`,`par_mindeslprofvalue`,`par_mingapprof`,`par_modootimizacao`,`par_niveldifdisci`,`par_percmindout`,`par_percminmest`,`par_prefprof`,`par_profmuitoscampi`,`par_regrasespdivcred`,`par_regrasgendivcre`,`version`,`cam_id`,`cen_id`,`sem_id`,`tur_id`) VALUES 
 ...
 (50,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,1,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6),
 (51,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,1,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6),
 (52,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,1,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6),
 (53,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,0,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6),
 (54,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,0,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6),
 (55,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,0,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6),
 (56,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,0,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6),
 (57,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,0,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6),
 (58,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,0,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6),
 (59,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,0,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6),
 (60,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,0,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6),
 (61,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,0,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6),
 (62,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,0,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6),
 (63,0x00,0x00,0x00,0x00,0x00,'CONCENTRAR',0x00,'CONCENTRAR',0x00,0x00,0x00,0x00,0,0x00,0,0x00,0x00,0x00,0,0x00,0x00,0x00,0,0x00,'TATICO',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0,8,1,2,6);
