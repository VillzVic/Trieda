...
% Pode tirar se for colocar a_{i,d,s,oft} do modelo, e deixar só a restrição correspondente a essa abaixo!
...
% Pode tirar se for colocar a_{i,d,s,oft} do modelo, e acrescentar a restrição abaixo
%
...
\begin{eqnarray}
\sum\limits_{d \in D} \sum\limits_{i \in I_{d}} sab_{i,d,s} \le TempoMaxSab_{s} \nonumber \qquad 
\forall s \in S \quad
\end{eqnarray}
