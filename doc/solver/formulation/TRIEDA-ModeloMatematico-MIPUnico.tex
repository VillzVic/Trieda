...
\item $hia_{a,t}$ - indica o horário de início das aulas do aluno $a$ (em minutos) no dia $t$.
\item $hfa_{a,t}$ - indica o horário de fim das aulas do aluno $a$ (em minutos) no dia $t$.
\item $fpgap_{p,t,f}$ - folga indicando se existe gap nos horários alocados ao professor $p$ na fase $f$ do dia $t$.
\item $fagap_{a,t}$ - folga indicando se existe gap nos horários alocados ao aluno $a$ no dia $t$.
...
\sum\limits_{t \in T} \sum\limits_{i \in I_{d}} fk_{d,i,k}
      ...
      \\
      &
      + \omega \cdot \sum\limits_{a \in A} \sum\limits_{t \in T} fagap_{a,t}
...
\subsubsection{Seta o lower bound para a variável $hia_{a,t}$}
...
\subsubsection{Seta o upper bound para a variável $hia_{a,t}$}
...
\subsubsection{Seta o lower bound para a variável $hfa_{a,t}$}
...
\subsubsection{Seta o upper bound para a variável $hfa_{a,t}$}
...
\begin{eqnarray}
\sum\limits_{i} \sum\limits_{d} \sum\limits_{s} \sum\limits_{hi} \sum\limits_{hf} tempo_{v} \cdot v_{a,i,d,s,t,hi,hf} + delta_{a,t} + fagap_{a,t} \geq hfa_{a,t} - hia_{a,t} \nonumber \qquad
\forall a \in A \quad
\forall t \in T
\end{eqnarray}
