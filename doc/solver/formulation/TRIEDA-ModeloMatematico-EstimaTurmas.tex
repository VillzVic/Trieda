...
\item $xcs1_{s,g}$ - variável inteira que indica ocupação da sala $s$ no turno $g$ sem custo.
\item $xcs2_{s,g}$ - variável inteira de saturação da ocupação da sala $s$ no turno $g$ com custo baixo.
\item $xcs3_{s,g}$ - variável inteira de saturação da ocupação da sala $s$ no turno $g$ com custo alto.
