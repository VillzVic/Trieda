...
\begin{eqnarray}
\sum\limits_{pv \in PV_{d}}\sum\limits_{a \in A_{c}}\sum\limits_{\substack {h' \in H \\ h'\mbox{ sobrepoe }h}} x_{pv,a,h'} \le npvm_{c} \nonumber \qquad 
\forall h \in H \quad
\forall c \in C \quad
\forall t \in T
\end{eqnarray}
...
\begin{eqnarray}
\sum\limits_{pv \in PV_{g}}\sum\limits_{a \in A_{c}}\sum\limits_{\substack {h' \in H \\ h'\mbox{ sobrepoe }h}} x_{pv,a,h'} \le npvm_{c} \nonumber \qquad 
\forall h \in H \quad
\forall c \in C \quad
\forall t \in T
\end{eqnarray}
