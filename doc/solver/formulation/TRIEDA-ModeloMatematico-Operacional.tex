...
\begin{eqnarray}
\sum\limits_{d \in D} dpc_{d,p,c} \le M \cdot w_{p,c} \nonumber \qquad 
\forall p \in P \quad
\forall c \in C
\end{eqnarray}

\begin{eqnarray}
\sum\limits_{d \in D} dpc_{d,p,c} \ge w_{p,c} \nonumber \qquad 
\forall p \in P \quad
\forall c \in C
\end{eqnarray}
...
\begin{eqnarray}
\sum\limits_{i \in I_{d,c}} y_{p,d,i} \ge dpc_{p,c,d} \nonumber \qquad 
\forall p \in P \quad
\forall c \in C \quad
\forall d \in D
\end{eqnarray}    
...
\begin{eqnarray}
\sum\limits_{d \in D_{c}} dpc_{p,c,d} - fmdpc_{p,c} \le MaxDiscProfCurso_{p,c} \nonumber \qquad 
\forall p \in P \quad
\forall c \in C
\end{eqnarray}
