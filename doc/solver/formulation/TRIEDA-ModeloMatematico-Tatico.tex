...
\begin{eqnarray}
x_{i,d,u,s,t} + \sum\limits_{u' \in U} \sum\limits_{d' \in oft1 U oft2} \sum\limits_{i' \in I_{d'}}( x_{i',d',u',s',t} )
\le Q_{bc,t} + M ( 2 - e_{i,d,oft1} - e_{i,d,oft2} ) \nonumber \qquad
\\ \nonumber 
\forall d \in D_{oft1} \cap D_{oft2} \qquad 
\forall i \in I_{d} \quad 
\forall u \in U \quad 
\forall s \in S_{u} \quad 
