...
\subsubsection{Ativação da variável cs}
...
\subsubsection{Máximo de créditos por sala, dia e semana letiva}


\begin{eqnarray}
	
	 \sum\limits_{d \in D_{sl}}\sum\limits_{i \in I_{d}} ( x_{i,d,u,s,t} ) \le \sum\limits_{kh \in Kh_{s,t}} ( Q_{sl,kh,s,t} \cdot cs_{s,t,kh} ) \qquad
