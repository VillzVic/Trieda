...
\le Q_{bc,t} + M ( 2 - e_{i,d,oft1} - e_{i,d,oft2} ) \qquad 
...
\begin{eqnarray}
	 ...
	 \sum\limits_{kh \in Kh_{s,t}} cs_{s,t,kh} \le 1 \qquad
...
\begin{eqnarray}
	 ...
	 \sum\limits_{d \in D_{sl}}\sum\limits_{i \in I_{d}} ( x_{i,d,u,s,t} ) \le \sum\limits_{kh \in Kh_{s,t}} ( Nh_{sl,kh,s,t} \cdot cs_{s,t,kh} ) \qquad
