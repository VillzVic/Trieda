...
% Part 1
\begin{eqnarray}
\sum_{ \substack {hi,hf \in H \\ dti \in [hi,hf)} } \sum\limits_{s} x_{i,d,s,t,hi,hf} \le k_{p,i,d,t,dti} + ( 1 - y_{p,i,d} ) \nonumber \qquad
\\
\forall i \in I \quad
\forall d \in D \quad
\forall p \in P \quad
...
% Part 2
\begin{eqnarray}
\sum_{ \substack {hi,hf \in H \\ dti \in [hi,hf)} } \sum\limits_{s} x_{i,d,s,t,hi,hf} \le \sum\limits_{p} k_{p,i,d,t,dti} \nonumber \qquad
\\
\forall i \in I \quad
\forall d \in D \quad
\forall t \in T \quad
...
\begin{eqnarray}
\sum\limits_{t} \sum\limits_{h} k_{p,i,d,t,h} = nCreds_{d} \cdot y_{p,i,d} \nonumber \qquad
\forall i \in I \quad
\forall d \in D \quad
\forall p \in P
\end{eqnarray}	
