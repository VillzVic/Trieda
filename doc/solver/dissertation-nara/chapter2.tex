...
The absence of credits split rules can therefore reduce solution space quality, since it inserts a fake symmetry between solutions, and even hamper the convergence while searching for the best solution, since it boosts \fixme{boost esta correto?} solution space.
